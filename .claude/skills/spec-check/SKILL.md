...
Run every vault-hygiene check Musubi ships and produce a one-screen report. Designed to be fast (< 15 s on the current vault) and to be runnable from any agent (not Claude Code specific).
