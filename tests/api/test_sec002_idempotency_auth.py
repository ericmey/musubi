...
@pytest.mark.xfail(strict=True, reason="SEC-002: replay served with NO bearer — deferred; closed by slice-idempotency-phase-b (PR #404, Issue #407)")
...
@pytest.mark.xfail(strict=True, reason="SEC-002: replay served to INVALID bearer — deferred; closed by slice-idempotency-phase-b (PR #404, Issue #407)")
...
@pytest.mark.xfail(
    strict=True, reason="SEC-002: one tenant replays another tenant's write — deferred; closed by slice-idempotency-phase-b (PR #404, Issue #407)"
)
