---
title: "ADR 0016: Obsidian vault lives in the monorepo at `docs/Musubi/`"
...
# ADR 0016: Obsidian vault lives in the monorepo at `docs/Musubi/`
...
- The vault is **moved**, not copied: `~/Vaults/musubi/` is retired in favour of `~/Projects/musubi/docs/Musubi/`. Existing Obsidian workspaces are re-pointed at the new path.
...
### B) Vault as a git submodule under `docs/Musubi/`
