...
*(Note: `tests/retrieve/test_hybrid.py` ownership was transferred to [[_slices/slice-ret004-evals]] / Issue 430 on 2026-07-13).*
...
- Recommended follow-up: reconcile `docs/Musubi/05-retrieval/hybrid-search.md` so the Test Contract bullet name and implemented empty-query behavior match. That reconciliation belongs to the `slice-retrieval-hybrid` `status: done` prerequisite, not this PR.
