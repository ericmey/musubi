...
**`in-progress`** (2026-07-14) — Option-A source implemented locally and awaiting exact-head independent
review. C6b (Qdrant↔SQLite atomicity) remains the named dependency and must be reviewable before this
source merges. Tracking Issue #433. Second reader: Tama; Shiori available for an additional read.
...
exact-set callsite guard. C6b atomicity remains a concrete linked dependency, reviewable before merge.
