...
No spec edits expected; if you find the spec under-specifies any of these, update it in-PR with a `spec-update: docs/Musubi/04-data-model/episodic-memory.md` trailer.
