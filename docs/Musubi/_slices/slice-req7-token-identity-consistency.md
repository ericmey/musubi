...
4. `test_consistent_presence_and_scope_is_accepted`
5. `test_same_tenant_shared_scope_is_accepted`
6. `test_operator_and_global_scopes_remain_valid`
7. `test_wrong_issuer_is_rejected`
8. `test_missing_presence_is_rejected`
9. `test_d6_identity_is_issuer_subject_presence_not_jti`
