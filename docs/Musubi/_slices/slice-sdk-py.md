...
> `spec-update: docs/Musubi/07-interfaces/sdk.md` commit trailer — rename
...
- Spec rename `musubi-client` → `musubi.sdk` (ADR-0015 / ADR-0016) applied in same PR with `spec-update: docs/Musubi/07-interfaces/sdk.md` trailer on the feat commit.
